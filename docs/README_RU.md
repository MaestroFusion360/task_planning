...
Программа предоставляется по лицензии **"Коммерческая лицензия на 1 рабочее место"**.  
Лицензия предоставляет право использования программного обеспечения на одном физическом или виртуальном рабочем месте в коммерческих целях. Использование разрешено только одному пользователю одновременно. Распространение, передача третьим лицам и установка на дополнительные устройства без отдельной лицензии запрещены.
...
- Использовать программу в коммерческих целях без действующей лицензии.
- Удалять информацию о праве собственности (copyright) на программу.
...
- Потерю данных.
- Косвенные убытки.
- Несовместимость с другим программным обеспечением.
